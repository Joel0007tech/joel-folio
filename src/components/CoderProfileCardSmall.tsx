...
const coderData = {
  ...
  skills: [
    ...
    'TailwindCSS', 'CSS', 'Figma', 'GitHub', 'HTML', 'Node.js','Git'
  ],
};
...
export const CoderProfileCard = () => {
  return (
    ...
    <div className="w-[280px] relative right-2.5 sm:block hidden bg-gradient-to-r from-zinc-100 to-zinc-200 dark:from-[#000000] dark:to-[#0a0d37] border-zinc-300 dark:border-[#1b2c68a0] rounded-lg border shadow-lg">

      {/* Top gradient border element */}
      <div className="flex flex-row">
        <div className="h-[2px] w-32 bg-gradient-to-r from-transparent via-pink-500 to-violet-600"></div>
        <div className="h-[2px] w-32 bg-gradient-to-r from-violet-600 to-transparent"></div>
      </div>
      ...
      <div className="overflow-hidden border-t-[2px] border-zinc-300 dark:border-indigo-900 px-4 lg:px-8 py-4 lg:py-8 relative">
        ...
        <div className="absolute -top-24 -left-24 w-32 h-32 bg-blue-600 rounded-full opacity-10 filter blur-3xl"></div>
        <div className="absolute -bottom-24 -right-24 w-32 h-32 bg-pink-600 rounded-full opacity-10 filter blur-3xl text-sm"></div>
        ...
        <div className="relative flex">
          ...
          <code className="font-mono text-sm md:text-sm lg:text-base">
            <div>
              <span className="mr-2 text-pink-500 dark:text-pink-400 text-sm">const</span>
              <span className="mr-2 text-violet-500 dark:text-violet-400 text-sm">coder</span>
