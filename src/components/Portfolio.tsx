...
export const CoderProfileCard = () => {
  return (
    ...
    <div className="w-[620px] h-fit relative top-10 left-36 bg-gradient-to-r from-zinc-100 to-zinc-200 dark:from-[#000000] dark:to-[#0a0d37] border-zinc-300 dark:border-[#1b2c68a0] rounded-lg border shadow-lg">
      ...
      <div className="overflow-hidden border-t-[2px] border-zinc-300 dark:border-indigo-900 px-4 lg:px-8 py-4 lg:py-8 relative">
        ...
        <div className="absolute -bottom-24 -right-24 w-32 h-32 bg-pink-600 rounded-full opacity-10 filter blur-3xl"></div>
